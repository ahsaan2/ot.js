...
EditorSocketIOServer.prototype.addClient = function (socket) {
  ...
  // Emit the initial document state after joining the room
  socket.emit('doc', {
    str: this.document,
...
// Set up event listener for selection updates
...
socket.on('disconnect', () => {
  ...
  // Check if the room is empty and emit an event if it is
  if (
